 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: ExtensionFileFilterSwing.java 4172 2011-02-17 14:08:14Z mayer $
 */
public class ExtensionFileFilterSwing extends FileFilter {
    ...
    public ExtensionFileFilterSwing(boolean allowGzip, String extension) {
        this(allowGzip, new String[] { extension });
    }

    public ExtensionFileFilterSwing(boolean allowGzip, String... extensions) {
        ...
        for (String extension : extensions) {
            ...
            if (!extension.endsWith(".gz") && allowGzip) {
                description += ", *." + extension + ".gz";
            }
        }
    }

    public ExtensionFileFilterSwing(boolean allowGzip, String description, String... extensions) {
        this.extensions = extensions;
    ...
    public ExtensionFileFilterSwing(String description, String... extensions) {
        this(true, description, extensions);
    }
    ...
    public boolean accept(File f) {
        ...
        for (String extension : extensions) {
            if (f.getName().endsWith("." + extension) || allowGzip && f.getName().endsWith("." + extension + ".gz")) {
                return true;
            }
        }
        return false;
