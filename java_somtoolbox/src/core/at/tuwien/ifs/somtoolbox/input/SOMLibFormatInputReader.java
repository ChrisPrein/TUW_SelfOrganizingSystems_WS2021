 ...
 * @author Rudolf Mayer
 * @version $Id: SOMLibFormatInputReader.java 4059 2011-02-03 10:31:34Z mayer $
 */
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (line.startsWith("$TYPE")) {
                    ...
                    if (lineElements.length > 1) {
                        ...
                        throw new SOMLibFileFormatException(
                                "Map description file corrupt: no x-dimension specified in line '" + line + "'.");
                    }
                    ...
                    if (lineElements.length > 1) {
                        ...
                        throw new SOMLibFileFormatException(
                                "Map description file corrupt: no y-dimension specified in line '" + line + "'.");
                    }
                    ...
                    if (lineElements.length > 1) {
                        ...
                        throw new SOMLibFileFormatException(
                                "Map description file corrupt: no z-dimension specified in line '" + line + "'.");
                    }
                    ...
                    if (lineElements.length > 1) {
                        ...
                        throw new SOMLibFileFormatException(
                                "Map description file corrupt: no vector dimension specified in line '" + line + "'.");
                    }
                    ...
                    if (lineElements.length > 1) {
                        ...
                        throw new SOMLibFileFormatException(
                                "Map description file corrupt: no metric specified in line '" + line + "'.");
                    }
                } else if (line.startsWith("$DATA_TYPE")) {
                    String[] lineElements = line.split(StringUtils.REGEX_SPACE_OR_TAB);
                    if (lineElements.length > 1) {
                        contentType = ContentType.parse(lineElements[1]);
                    } else {
                        contentType = ContentType.UNKNOWN;
                        Logger.getLogger("at.tuwien.ifs.somtoolbox").warning(
                                "Map description file corrupt: no data type specified in line '" + line
