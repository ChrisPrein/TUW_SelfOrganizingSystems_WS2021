 ...
 * @author Rudolf Mayer
 * @author Jakob Frank
 * @version $Id: PaletteEditor.java 4353 2015-03-10 16:33:57Z mayer $
 */
public class PaletteEditor extends JFrame {
    ...
    private JComboBox<Palette> cmbPalettes = null;
    ...
    private JPanel getEmbeddedPaletteSelector() {
        ...
        cmbPalettes = new JComboBox<Palette>(Palettes.getAvailablePalettes());
        if (somViewer != null) {
            cmbPalettes.setSelectedItem(somViewer.getCurrentlySelectedPalette());
        } else {
            ...
            btnNew.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (mode == SOMVIEWER) {
                        ...
                        if (state != null) {
                            cmbPalettes.setModel(new JComboBox<Palette>(Palettes.getAvailablePalettes()).getModel());
