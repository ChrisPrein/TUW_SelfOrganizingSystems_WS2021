 ...
 * @author Rudolf Mayer
 * @version $Id: SOMPane.java 4023 2011-01-26 17:46:17Z frank $
 */
public class SOMPane extends GenericPNodeScrollPane {
    ...
    private void updateClassSelection(int[] indices, MapPNode mapPNode) {
        ...
        for (BackgroundImageVisualizer v : Visualizations.getReadyVisualizations()) {
            if (v.getClass().equals(ThematicClassMapVisualizer.class)) {
                ((ThematicClassMapVisualizer) v).forceRepaint();
            }
        }
    }
