...
/**
 * @author Rudolf Mayer
 * @version $Id: AbstractSelectionPanel.java 4356 2015-03-10 16:54:51Z mayer $
 */
public abstract class AbstractSelectionPanel extends AbstractViewerControl implements UnitSelectionListener,
    ...
    protected DefaultListModel<String>[] playlistmodels;

    protected JList<String>[] playlists;
    ...
    public AbstractSelectionPanel(LayoutManager layout, CommonSOMViewerStateData state, String title,
        ...
        for (int i = 0; i < selectionAreaCount; i++) {
            playlistmodels[i] = new DefaultListModel<String>();
            playlists[i] = new JList<String>(playlistmodels[i]);
