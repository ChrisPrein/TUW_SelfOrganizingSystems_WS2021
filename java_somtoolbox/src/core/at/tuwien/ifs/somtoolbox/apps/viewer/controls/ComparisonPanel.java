 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: ComparisonPanel.java 4355 2015-03-10 16:47:40Z mayer $
 */
public class ComparisonPanel extends AbstractSelectionPanel implements ActionListener {
    ...
    private JList<String> unionList;
    ...
    public void showLabels(String labelType, String sortBy) {
        ...
        DefaultListModel<String> unionListModel = new DefaultListModel<String>();
