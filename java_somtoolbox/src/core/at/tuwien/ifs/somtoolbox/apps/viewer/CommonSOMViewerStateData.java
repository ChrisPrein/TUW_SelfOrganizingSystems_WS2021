 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: CommonSOMViewerStateData.java 4180 2011-02-18 12:45:36Z mayer $
 */
public class CommonSOMViewerStateData {
    ...
    private String dataImagesMode = SOMViewer.TOGGLE_DATA_IMAGES;
    ...
    public String getDataImagesMode() {
        return dataImagesMode;
    }

    public void setDataImagesMode(String dataImagesMode) {
        this.dataImagesMode = dataImagesMode;
    }
