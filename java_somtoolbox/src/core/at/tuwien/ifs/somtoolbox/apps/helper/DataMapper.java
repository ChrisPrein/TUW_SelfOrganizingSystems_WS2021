 ...
 * @author Rudolf Mayer
 * @version $Id: DataMapper.java 4230 2011-12-01 09:47:20Z frank $
 */
public class DataMapper implements SOMToolboxApp {
    ...
    public DataMapper(String[] args) throws FileNotFoundException, IOException, SOMToolboxException {
        ...
        String[] skipClassesString = config.getStringArray("classList");
        ArrayList<String> mappingExceptions = new ArrayList<String>(Arrays.asList(skipClassesString));
        ...
        if (outputPrefix == null) {
            ...
            // FIXME: [Jakob] can't see the reason for this, and it breakes DataMapperTest:
            // outputPrefix = FileUtils.appendDirectorySeparator(outputPrefix);
        }
        try {
