 ...
 * @version $Id: MultichannelPlaybackPanel.java 4310 2014-01-09 14:15:17Z mayer $
 */
...
public class MultichannelPlaybackPanel extends AbstractSelectionPanel implements ActionListener, ListSelectionListener {
    ...
    public MultichannelPlaybackPanel(CommonSOMViewerStateData state, SOMPane somPane) {
        ...
        try {
            String jvmSpecVersionStr = System.getProperty("java.specification.version");
            double jvmSpec = Double.parseDouble(jvmSpecVersionStr);
            if (jvmSpec < 1.5) {
                Commons.log.info("You are using Java version " + jvmSpecVersionStr + "...");
