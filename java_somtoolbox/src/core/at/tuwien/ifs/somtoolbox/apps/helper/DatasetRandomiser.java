 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: DatasetRandomiser.java 4338 2015-03-06 14:49:40Z mayer $
 */
public class DatasetRandomiser implements SOMToolboxApp {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String inputVectorFile = AbstractOptionFactory.getFilePath(options, "inputVectorFile");
        String templateVectorFile = AbstractOptionFactory.getFilePath(options, "templateVectorFile");
        String ouputFile = AbstractOptionFactory.getFilePath(options, "output");
