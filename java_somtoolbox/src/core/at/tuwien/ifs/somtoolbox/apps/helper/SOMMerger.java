 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: SOMMerger.java 4269 2012-04-03 14:54:05Z mayer $
 */
public class SOMMerger implements SOMToolboxApp {
    ...
    public static void main(String[] args) throws SOMLibFileFormatException, IOException {
        ...
        // then, merge them
        SOMLibInputConcatenator.mergeVectors(inputs, vectorFiles, config.getString("output"), config.getString("mode"),
                mapSize);
    }
