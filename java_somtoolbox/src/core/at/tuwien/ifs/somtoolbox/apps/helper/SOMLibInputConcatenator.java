...
/**
 * Concatenates two or more SOMLib Input files, i.e. vector and template files. Template vectors can be off different
 ...
 * retaining a feature if it appears in at least x sets. This class is a bit similar to {@link VectorFileConcatenator},
 * but more generic in the number of inputs it can take, and in the merging strategies, though it doesn't support the
 * weighting strategies implemented in {@link VectorFileConcatenator}.
 * 
 * @author Rudolf Mayer
 * @version $Id: SOMLibInputConcatenator.java 4269 2012-04-03 14:54:05Z mayer $
 */
// FIXME: merge this with VectorFileConcatenator at some point
public class SOMLibInputConcatenator implements SOMToolboxApp {
