 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: StringUtils.java 4285 2014-01-05 17:29:42Z mayer $
 */
public class StringUtils {
    ...
    public static String beautifyForHTML(String source) {
        return beautify(source).replaceAll("&", "&amp;");
    }
    ...
    public static int indexOfStartsWithAny(String s, String suffix, String... options) {
        ...
        for (int i = 0; i < options.length; i++) {
            if (s.startsWith(options[i] + suffix)) {
                return i;
            }
        }
        return -1;
    ...
    /**
     * Gets the stack trace of the exception, as it would be printed through {@link Exception#printStackTrace()}, as a
     * String
     */
    ...
    /**
     * Works analogous to {@link org.apache.commons.lang.StringUtils#defaultIfEmpty(String, String)}, but using
     * {@link org.apache.commons.lang.StringUtils#isBlank(String)} instead of
     * {@link org.apache.commons.lang.StringUtils#isEmpty(String)}
     */
    public static String defaultIfBlank(String s, String defaultValue) {
        return org.apache.commons.lang.StringUtils.isEmpty(s) ? defaultValue : s;
    }

    public static String substringMore(String s, int maxlen) {
        if (s.length() < maxlen) {
            return s;
        } else {
