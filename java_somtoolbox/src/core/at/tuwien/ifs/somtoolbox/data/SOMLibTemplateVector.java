...
import at.tuwien.ifs.commons.util.collection.Pair;
 ...
 * @author Rudolf Mayer
 * @version $Id: SOMLibTemplateVector.java 4223 2011-10-06 16:35:01Z mayer $
 */
public class SOMLibTemplateVector extends AbstractSOMLibTemplateVector {
    ...
    public SOMLibTemplateVector(int numVectors, String[] componentNames, int numInfo) {
    ...
    public SOMLibTemplateVector(int numVectors, String[] componentNames) {
    ...
    public void readTemplateVectorFile(String templateFileName) throws IOException {
        ...
        Pair<String, Integer> temp = readTemplateVectorFileHeader(br);
        String line = temp.getFirst();
        int lineNumber = temp.getSecond();
        elements = new TemplateVectorElement[dim];
        ...
        while (line != null) {
            ...
            if (lineElements.length != numInfo) {
                ...
                // check index
                if (index >= dim) {
                    throw new IOException("Template vector file corrupt, attempting to read dimension #" + (index + 1)
                            + ", specified dimensionality is " + dim + " " + getErrorDetails(line, lineNumber)
                            + ". Aborting.");
                }
                try {
    ...
    protected Pair<String, Integer> readTemplateVectorFileHeader(BufferedReader br) throws IOException {
        String line = null;
        int lineNumber = 0;
        ...
        return new Pair<String, Integer>(line, lineNumber);
    }
