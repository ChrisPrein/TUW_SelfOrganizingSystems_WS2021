 ...
 * @author Rudolf Mayer
 * @version $Id: InputData.java 4142 2011-02-08 15:52:38Z mayer $
 */
public interface InputData {
    ...
    /** Return the minimum value in the input data. The value is the global minimum, i.e. over all features. */
    public double getMinValue();

    /** Return the maximum value in the input data. The value is the global maximum, i.e. over all features. */
