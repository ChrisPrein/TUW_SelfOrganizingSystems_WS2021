 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: InputDataFactory.java 4054 2011-02-01 16:55:54Z mayer $
 */
public class InputDataFactory {
    ...
    public static InputData open(String vectorFileName, String templateFileName, boolean sparse, boolean norm,
        ...
        try {
            ...
            Logger.getLogger("at.tuwien.ifs.somtoolbox").info(e1.getMessage());
            Logger.getLogger("at.tuwien.ifs.somtoolbox").info("Probing for SOMLib format");
        }
    ...
    public static String detectInputFormatFromExtension(String inputFileName, String type) throws SOMToolboxException {
        ...
        throw new SOMToolboxException("Could not determine " + type + " format for file '" + inputFileName
                + "' from extension, please specify the " + type + " format via the option.");
    }
