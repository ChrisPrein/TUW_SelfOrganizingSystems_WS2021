 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: InputDataFileFormatConverter.java 4054 2011-02-01 16:55:54Z mayer $
 */
public class InputDataFileFormatConverter implements SOMToolboxApp {
    ...
    public static void main(String[] args) throws IOException, SOMToolboxException {
        ...
        InputDataWriter.write(outputFileName, data, outputFormat, tabSeparatedClassFile, skipInstanceNames,
