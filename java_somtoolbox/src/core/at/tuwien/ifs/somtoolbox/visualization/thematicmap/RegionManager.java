 ...
 * @version $Id: RegionManager.java 4028 2011-01-29 22:28:40Z mayer $
 */
public class RegionManager {
    ...
    public RegionManager(SOMLibClassInformation classInfo, ArrayList<Color> paintList, int width, int height,
