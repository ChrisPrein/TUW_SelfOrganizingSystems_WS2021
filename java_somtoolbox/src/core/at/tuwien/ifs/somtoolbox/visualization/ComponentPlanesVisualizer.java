 ...
 * @author Rudolf Mayer
 * @version $Id: ComponentPlanesVisualizer.java 4163 2011-02-11 17:08:02Z mayer $
 */
public class ComponentPlanesVisualizer extends AbstractItemVisualizer {
    ...
    protected String getVisualisationSpecificCacheKey(int currentVariant) {
        return super.getVisualisationSpecificCacheKey(currentVariant) + CACHE_KEY_SECTION_SEPARATOR + "component:"
                + (templateVector != null ? templateVector.getLabel(currentElement) : currentElement);
    }
    ...
    public void setInputObjects(SharedSOMVisualisationData inputObjects) {
        ...
        templateVector = inputObjects.getTemplateVector();
    }
