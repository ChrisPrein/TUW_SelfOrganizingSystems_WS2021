 ...
 * @author Rudolf Mayer
 * @version $Id: AbstractBackgroundImageVisualizer.java 4357 2015-03-10 17:02:45Z mayer $
 */
public abstract class AbstractBackgroundImageVisualizer implements BackgroundImageVisualizer {
    ...
    public class VisualizationControlPanel extends JPanel implements ComponentListener {
        ...
        protected final JComboBox<AbstractBackgroundImageVisualizer.ContourMode> contourComboBox = new JComboBox<AbstractBackgroundImageVisualizer.ContourMode>(
                ContourMode.values());
        ...
        public VisualizationControlPanel(String name) {
            ...
            if (AbstractBackgroundImageVisualizer.this instanceof MatrixVisualizer) {
                ...
                final JComboBox<AbstractBackgroundImageVisualizer.ContourInterpolationMode> contourInterpolationComboBox = new JComboBox<AbstractBackgroundImageVisualizer.ContourInterpolationMode>(
                        ContourInterpolationMode.values());
