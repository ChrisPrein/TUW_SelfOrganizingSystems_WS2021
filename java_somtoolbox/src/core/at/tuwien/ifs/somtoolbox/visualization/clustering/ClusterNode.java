 ...
 * @version $Id: ClusterNode.java 4349 2015-03-10 15:52:38Z mayer $
 */
public class ClusterNode implements Serializable {
    ...
    public ClusterNode(ClusterNode n1, ClusterNode n2, int level) {
        ...
        this.setHeight(Math.max(n1.getY() + n1.getHeight(), n2.getY() + n2.getHeight())
    ...
    public void setMergeCostSum(Double _value) {
        mergeCostSum = _value;
    }
