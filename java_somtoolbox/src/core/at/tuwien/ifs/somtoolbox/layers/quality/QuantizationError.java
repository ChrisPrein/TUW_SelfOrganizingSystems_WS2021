 ...
 * @author Rudolf Mayer
 * @version $Id: QuantizationError.java 4342 2015-03-06 15:56:51Z mayer $
 */
public class QuantizationError extends AbstractQualityMeasure {
    public static final String MQE_MAP = "MQE_Map";

    public static final String QE_MAP = "QE_Map";

    public static final String MQE_UNIT = "MQE_Unit";

    public static final String QE_UNIT = "QE_Unit";
    ...
    public double getMapQuality(String name) throws QualityMeasureNotFoundException {
        if (name.equals(QE_MAP)) {
            return mqe;
        } else if (name.equals(MQE_MAP)) {
            return mmqe;
        } else {
    ...
    public double[][] getUnitQualities(String name) throws QualityMeasureNotFoundException {
        if (name.equals(QE_UNIT)) {
            return unitQe;
        } else if (name.equals(MQE_UNIT)) {
            return unitMqe;
        } else {
            throw new QualityMeasureNotFoundException("Quality measure with name " + name + " not found.");
        }
