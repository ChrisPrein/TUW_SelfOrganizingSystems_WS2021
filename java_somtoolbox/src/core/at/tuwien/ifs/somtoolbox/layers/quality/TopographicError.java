 ...
 * @version $Id: TopographicError.java 4334 2015-01-13 13:09:29Z mayer $
 */
public class TopographicError extends AbstractQualityMeasure {

    public static final String TE8_UNIT = "TE8_Unit";

    public static final String TE_UNIT = "TE_Unit";

    public static final String TE8_MAP = "TE8_Map";

    public static final String TE_MAP = "TE_Map";
    ...
    public TopographicError(Layer layer, InputData data) {
        ...
        mapQualityNames = new String[] { TE_MAP, TE8_MAP };
        mapQualityDescriptions = new String[] { TE_MAP, TE8_MAP };
        unitQualityNames = new String[] { TE_UNIT, TE8_UNIT };
        unitQualityDescriptions = new String[] { TE_UNIT, TE8_UNIT };
