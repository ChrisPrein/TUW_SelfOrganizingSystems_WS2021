 ...
 * because it already contains the hierarchical functionality, only the training procedure would have to be updated.
 * 
 * @author Michael Dittenbach
 * @version $Id: GHSOM.java 3995 2011-01-19 14:50:20Z mayer $
 */
public class GHSOM extends AbstractNetworkModel implements SOMToolboxApp {
    ...
    public static void main(String[] args) {
        ...
        if (labeler != null) { // if labeling then label
     ...
     * determines whether the randomly initialised weight vectors should be normalised to unit length or not.
     * 
